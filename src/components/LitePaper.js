...
const LitePaper = () => {
  ...
  const sections = [
    {
      title: "Overview",
      content: `B1TCOIN.Ai: The next-gen Web3 game empowering users to earn SCT tokens through real-world tasks, contributing to the digital twin revolution.`,
      icon: Zap,
    },
    {
      title: "Mission",
    ...
    {
      title: "Vision",
      content: `Create a world where gaming and reality converge, empowering users to shape the digital landscape while earning rewards. B1TCOIN.Ai: Where your actions build the future.`,
      icon: Cpu,
    },
  ];
