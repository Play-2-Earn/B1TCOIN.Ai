...
const WhitePaper = () => {
  ...
  const sections = [
    {
      title: "Introduction",
      content: `B1TCOIN.Ai is a revolutionary decentralized play-to-earn (P2E) platform built on the Stellar blockchain with IPFS integration. Players are rewarded with Stellar-native tokens (SCT) for completing hyper-local tasks that contribute to building digital twins for real-world companies.`,
    },
    {
      title: "Vision",
      content: `B1TCOIN.Ai aims to become the leader in Web3 gaming by decentralizing local interactions and providing valuable data for digital twin companies. We're creating a future where gaming meets real-world impact.`,
    },
    {
